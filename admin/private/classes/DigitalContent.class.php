...
class DigitalContent extends DatabaseObject {

  static protected $table_name = "digital_category";
  static protected $db_columns = ['id','category_name','image','seo_url','status'];
  public $id ;
  public $category_name;
  public $seo_url;
  public $status;
  public $image;
  public $upload_directory = "images/DigitalContent";
...

  {
    ...
    public static function find_by_page($per_page,$pagination)
    {
        ...
        $sql .= "where status ='Y'";
        $sql .= "order by category_name asc limit $per_page OFFSET {$pagination->offset()}";
  ...
  static public function find_by_single_content() {
    $sql = "SELECT * FROM " . static::$table_name . " ";
     $obj_array = static::find_by_sql($sql);
    if(!empty($obj_array)) {
      return array_shift($obj_array);
