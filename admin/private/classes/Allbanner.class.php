...
class Allbanner extends DatabaseObject {

  static protected $table_name = "all_banner";
  static protected $db_columns = ['id','image','url','banner_type','status','title'];
  public $id ;
  public $url;
  public $title;
  public $status;
  public $banner_type;
  public $image;
  public $upload_directory = "images/All_banner";
  ...
  public function __construct($args=[]) {
      ...
      $this->url = $args['url'] ?? '';
      $this->banner_type = $args['banner_type'] ?? '';
 ...
 static public function find_by_id($id) {
  ...
  static public function find_by_blog_banner()
  {
      $sql = "SELECT * FROM " . self::$table_name . " ";
      $sql .= "WHERE banner_type='B'";
      $result = self::$database->query($sql);
      if (!$result) {
          exit("Database query failed.");
      }
  ...
  static public function find_by_events_banner()
  {
      $sql = "SELECT * FROM " . self::$table_name . " ";
      $sql .= "WHERE banner_type='E'";
      $result = self::$database->query($sql);
      if (!$result) {
          exit("Database query failed.");
      }
  ...
  static public function find_by_webinar_banner()
  {
      $sql = "SELECT * FROM " . self::$table_name . " ";
      $sql .= "WHERE banner_type='W'";
      $result = self::$database->query($sql);
      if (!$result) {
          exit("Database query failed.");
      }
   ...
   static public function find_by_bookslist_banner()
  {
      $sql = "SELECT * FROM " . self::$table_name . " ";
      $sql .= "WHERE banner_type='L'";
      $result = self::$database->query($sql);
      if (!$result) {
          exit("Database query failed.");
      }
  ...
  static public function find_by_single_allbanner() {
    $sql = "SELECT * FROM " . static::$table_name . " ";
     $obj_array = static::find_by_sql($sql);
    if(!empty($obj_array)) {
      return array_shift($obj_array);
  ...
  public static function delete_allbanner($id)
  {
