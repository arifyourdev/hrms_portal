...
class SubDigitalContent extends DatabaseObject {

  static protected $table_name = "sub_digital_category";
  static protected $db_columns = ['id','digital_id','title','image','seo_url','status','description'];
  public $id ;
  public $digital_id;
  public $title;
  public $seo_url;
  ...
  public $image;
  public $description;
  public $upload_directory = "images/SubDigitalContent";
  ...
  public function __construct($args=[]) {
      ...
      $this->digital_id = $args['digital_id'] ?? '';
...
public static function find_by_page($per_page,$pagination)
  ...
  static public function find_by_single_subcontent() {
    $sql = "SELECT * FROM " . static::$table_name . " ";
     $obj_array = static::find_by_sql($sql);
    if(!empty($obj_array)) {
      return array_shift($obj_array);
   ...
   public static function d_category_name($d_id){
      $d_title = DigitalContent::find_by_id($d_id);
       return $d_title->category_name;
  }

  public static function delete_subcontent($id)
  {
