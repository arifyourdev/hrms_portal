...
class Pagination {
  ...
  public function previous_link($url="") {
    ...
    if($this->previous_page() != false) {
      $link .= "<li><a class='border_none_p' href=\"{$url}/{$this->previous_page()}\">";
      $link .= "<i class='fa-solid fa-angle-left'></i></a></li>";
    }
  ...
  public function next_link($url="") {
    ...
    if($this->next_page() != false) {
        $link .= "<li><a class='border_none_p' href=\"{$url}/{$this->next_page()}\">";
        $link .= "<i class='fa-solid fa-angle-right'></i></a></li>";
    }
    return $link;
  }
