...
class Admin extends DatabaseObject {
  ...
  static protected $db_columns = ['id', 'first_name', 'last_name', 'email', 'username', 'hashed_password','type'];
...
if($this->password_required){
  ...
  return $this->errors;
    ...
    static public function find_by_admin_id($id) {
        $sql = "SELECT * FROM  " . static::$table_name." ";
    ...
    static public function find_by_type()
    {
