<?php
 ...
 if (is_post_request()) {
    ...
    $args = $_POST['branch'];
    $branch = new Branches ($args);
    $branch->city_name = $name;
     
    $result = $branch->save('branch_id');
    
    if($result === true) {
	$session->message('The Branch Level created successfully.');
...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Add Branch | Madhubunbooks</title>
                            ...
                            <div class="card-body">
                                <form  method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="mt-3">
                                            <button type="submit" class="btn btn-primary" name="submit">Add Branches</button>
