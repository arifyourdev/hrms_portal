...
if($result === true) {
	$session->message('The Detail was Updated successfully.');
	// echo  '<script>window.location.href = "./project.php";</script>' ;
redirect_to(url_for('newsroom_detail'));
}
else {
	// show errors 
...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Update Newsroom Detail | Madhubunbooks</title>
