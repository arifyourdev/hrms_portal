...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Madhubunbook Dashboard</title>
        ...
        <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
            <div class="container-fluid">
                 <div class="row align-items-center">
                    <div class="col">
                        <h1 class="fs-5 color-900 mt-1 mb-0">Welcome back, Madhubunboks!</h1>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                ...
                                <div class="mb-2 text-uppercase">Total jobs</div>
                                <div><span class="h4"><?php echo BookApplication::count_all(); ?></span></div>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                ...
                                <div class="mb-2 text-uppercase">Total Books</div>
                                <div><span class="h4"><?php echo BookMaster::count_all() ?></span></div>
                                <!-- <small class="text-muted">Madhubunboks</small> -->
                            </div>
                            <div class="progress" style="height: 4px;">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card overflow-hidden">
                            ...
                            <svg class="position-absolute top-0 end-0 mt-4 me-3" xmlns="http://www.w3.org/2000/svg" width="26" fill="currentColor" viewBox="0 0 16 16">
                                ...
                                <div class="mb-2 text-uppercase">Total Series</div>
                                <div><span class="h4"><?php echo BookSeries::count_all() ?></span></div>
                             </div>
                            <div class="progress" style="height: 4px;">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6">
                        <div class="card overflow-hidden">
                            <div class="card-body">
                                ...
                                <div class="mb-2 text-uppercase">Total Subscription</div>
                                <div><span class="h4"><?php echo BookSubscription::count_all() ?></span></div>
                             </div>
                            <div class="progress" style="height: 4px;">
