<?php
 ...
 if (is_post_request()) {
    ...
    $args = $_POST['jobs'];
    $jobs = new CurrentOpening ($args);
    $jobs->job_title = $name;
    // $level->lavel_status = "Y";
    $result = $jobs->save('id');
    
    if($result === true) {
	$session->message('The Jobs is created successfully.');
	// echo  '<script>window.location.href = "./project.php";</script>' ;
	redirect_to('current_opening');
 }
 else {
	// show errors 
...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Add Current Opening | Madhubunbooks</title>
...
<body class="layout-1" data-luno="theme-black">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Add Current Opening</h6>
                            ...
                            <div class="card-body">
                                <form  method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        ...
                                        <div class="mt-3">
                                            <button type="submit" class="btn btn-primary" name="submit">Add Jobs</button>
    ...
    <script src="https://cdn.ckeditor.com/4.19.0/standard/ckeditor.js"></script>
     <script>
           CKEDITOR.replace('jobs[description]');
     </script>
    <!-- Plugin Js -->
