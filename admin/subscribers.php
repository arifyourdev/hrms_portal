...
$r_data = BookSubscription::find_by_order();
?>
<!doctype html>
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="myDataTable" class="table  table-hover nowrap align-middle mb-0 card-table" style="vertical-align: top!important;">
                                    <thead>
                                        <tr>
                                             <th>Sn</th>
                                             <th style="">Email</th>
