...
$pwu_data = BookPwu::find_by_order();
?>
<!doctype html>
...
<head>
    ...
    <title>Publish With Us | Madhubunbooks</title>
...
<body class="layout-1" data-luno="theme-black">
        ...
        <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        <h1 class="fs-5 color-900 mt-1 mb-0">Manage Publish With Us</h1>
                    </div>
                </div> <!-- .row end -->
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Manage Publish With Us</h6>
   ...
   "lengthMenu": [10, 25, 50, 75, 100],
        ...
        $(document).on('click','.pwu_delete',function() {
