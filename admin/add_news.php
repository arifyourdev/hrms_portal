...
$name = htmlentities($database->escape_string($_POST['news']['news_title']));


$args = $_POST['news'];
$news = new BookNews($args);
if(is_uploaded_file($_FILES['news_image']['tmp_name'])){
    $news->set_file($_FILES['news_image']);
    
    $news->news_title = $name;
    
    $result = $news->save_photo();
 }
 else {
    $news->news_title = $name;
...
if($result === true) {
	...
	// show errors 
	$session->message(join("<br>", $news->errors));
...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Add Manage News / Event | Madhubunbooks</title>
...
<body class="layout-1" data-luno="theme-black">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Manage News / Event</h6>
                          ...
                          <div class="text-center">
                            ...
                            <div class="card-body">
                                <form  method="post" enctype="multipart/form-data">
                                    <div class="row g-3">
                                        <?php include "form/news_form.php" ?>
                                        <div class="mt-3">
    ...
    <script src="https://cdn.ckeditor.com/4.19.0/standard/ckeditor.js"></script>
     <script>
           CKEDITOR.replace('news[news_detail]');
     </script>
    <!-- Plugin Js -->
