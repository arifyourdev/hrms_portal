        ...
        <div class="page-toolbar px-xl-4 px-sm-2 px-0 py-3">
            <div class="container-fluid">
                ...
                <div class="row align-items-center">
                    <div class="col-auto">
                        <h1 class="fs-5 color-900 mt-1 mb-0">Resource Request Approval</h1>
                    </div>
                </div> <!-- .row end -->
                    ...
                    <div class="col-12">
                        ...
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Resource Request Approval</h6>
                                <a href="requestr-resource" class="btn btn-info text-white">Not Approved List</a>
