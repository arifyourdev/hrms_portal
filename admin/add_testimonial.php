...
$testimonial = new BookTestimonial($args);
if(is_uploaded_file($_FILES['testimonial_image']['tmp_name'])){
    ...
    if($result === true) {
 	...
 	$session->message('The book testimonial created successfully.');
	// echo  '<script>window.location.href = "./project.php";</script>' ;
	redirect_to('testimonial');
 }
 else {
	// show errors 
	$session->message(join("<br>", $testimonial->errors));
...
<html class="no-js " lang="en">
 <head>
    ...
    <title>Add Testimonial | Madhubunbooks</title>
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Add Testimonial</h6>
